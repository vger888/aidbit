...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake, int64_t* pFees)
{
    ...
    CBitcoinAddress address(!fTestNet ? DONATION : DONATION_TEST);
    CBitcoinAddress address2(!fTestNet ? FOUNDATION : FOUNDATION_TEST);
    ...
    int64_t nFees = 0;
    {
        ...
        if (!fProofOfStake)
		{
		     ...
		     pblock->vtx[0].vout[1].nValue = POWRewardN * double(DONATION_PERCENT)/100;
		     pblock->vtx[0].vout[2].nValue = POWRewardN * double(FOUNDATION_PERCENT)/100;
		}
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    pblock->print();
    printf("generated %s\n", FormatMoney(pblock->vtx[0].vout[0].nValue + pblock->vtx[0].vout[1].nValue + pblock->vtx[0].vout[2].nValue).c_str());
